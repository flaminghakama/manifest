...
var originalSongs = {
    ...
    partsInBooks: {
        ...
        "English Horn": {
            "As It Was alt.musica": [ "English Horn in F", "Solo in C" ], 
            "Don't Wait for Me": [ "English Horn in F", "Solo in C" ],
            ...
            "Stomping Ground": [ "English Horn in F", "Lead Sheet" ],
            "Tension Cue": [ "English Horn in F" ],
            "We Declare alt.musica": [ "English Horn in F", "Lead Sheet" ], 
            "Windows": [ "English Horn in F", "Lead Sheet" ],
		},
        "Bass Clarinet": {
        ...
        "Voice/Percussion": {
            ...
            "The Optimist": [ "Voice" ],
            "Rising": [ "Voice" ],
            "Stomping Ground": [ "Clave", "Claps", "Lead Sheet" ], 
        ...
        "Drums": {
            ...
            "Stomping Ground": [ "Drums", "Clave" ],
            "Tension Cue": [ "Drums" ],
            "We Declare alt.musica": [ "Drums" ], 
            "Windows": [ "Drums", "Clave" ],
		},
        "Violin I": {
            "As It Was alt.musica": [ "Violin I", "Solo in C" ], 
            "Don't Wait for Me": [ "Violin I", "Solo in C" ],
            "Dreams": [ "Violin I" ], 
            "Listening": [ "Violin I" ],
            "Mossad": [ "Violin I" ],
            "The Nymph": [ "Violin I" ],
            ...
            "Stomping Ground": [ "Violin I", "Lead Sheet" ],
            "Tension Cue": [ "Violin I" ],
            "We Declare alt.musica": [ "Violin I", "Lead Sheet" ], 
            "Windows": [ "Violin I", "Lead Sheet" ],
		},
        "Violin II": {
    ...
    songs: {
        "As It Was alt.musica": {
            ...
            parts: {
                ...
                "Solo in C": { fileSuffix: "Solo-in-C" },
