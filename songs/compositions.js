...
var originalSongs = {
	...
	songs: {
		...
		"Listening": {
			...
			fileLocation: "alt.musica",
			filePrefix: "listening/",
			parts: {
				"Flute": { fileSuffix: "strings/listening-Flute" },
				"Flute (Sharps)": { fileSuffix: "sharps/listening-Flute" },
				"English Horn in F": { fileSuffix: "strings/listening-English-Horn-in-F" },
				"Clarinet in A": { fileSuffix: "strings/listening-Clarinet-in-A" },
				"Bass Clarinet in Bb": { fileSuffix: "strings/listening-Bass-Clarinet-in-Bb" },
				"Bass Clarinet in Bb for Bassoon": { fileSuffix: "strings/listening-Bass-Clarinet-in-Bb-for-Bassoon" },
				"Bassoon": { fileSuffix: "strings/listening-Bassoon" },
				"Voice": { fileSuffix: "strings/listening-Voice" },
				"Clave": { fileSuffix: "strings/listening-Clave" },
				"Violin I (Sharps)": { fileSuffix: "sharps/listening-Violin-I" },
				"Violin II (Sharps)": { fileSuffix: "sharps/listening-Violin-II" },
				"Viola (Sharps)": { fileSuffix: "sharps/listening-Viola" },
				"'Cello (Sharps)": { fileSuffix: "sharps/listening-Cello" },
				"Violin I": { fileSuffix: "strings/listening-Violin-I" },
				"Violin II": { fileSuffix: "strings/listening-Violin-II" },
				"Viola": { fileSuffix: "strings/listening-Viola" },
				"'Cello": { fileSuffix: "strings/listening-Cello" },
				"Bass": { fileSuffix: "strings/listening-Bass" }
			},
			scores: {
				"Transposed": { fileSuffix: "Score-Transposed" },
